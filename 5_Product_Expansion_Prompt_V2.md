# PRODUCT EXPANSION & COMPETITIVE EVOLUTION PROMPT — V2.0
...
| 13 | [Expansion Regression] | All chunks | Full regression suite | No regressions in Chunks 1-8 |
```
...
*Product Expansion & Competitive Evolution Prompt V2.0 | Updated: February 2026*
*Prompt #5 of 5: (1) PRD Authoring → (2) Red Team → (3) Build Briefing → (4) UAT & Ship → (5) Expansion*
*New in V2: Build Health Assessment, Insertion Complexity Classification (Additive/Extending/Refactoring), Regression Risk Assessment per feature, Build Integration Specifications (PRD Deltas, expansion chunks), Expansion Red Team Checklist, AI Safety Rules, Dependency Conflict Assessment, lifecycle loop back to Stage 1.*
